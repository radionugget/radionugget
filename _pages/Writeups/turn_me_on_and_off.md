...
date: "04-07-2024"
thumbnail: "/assets/img/thumbnail/turnme.gif"
---
...
Le challenge commence avec un challenge `sdr-challenge1.cfile`. 
Ouvrons-le avec [Universal Radio Hacker](https://github.com/jopohl/urh). 
![image](../../assets/img/writeups/turnme/turnme1.png)

Ok, on a plusieurs morceaux, en zoomant sur l'un d'autre eux, on peut supposer le type de modulation.
![image](../../assets/img/writeups/turnme/turnme2.png)
...
![image](../../assets/img/writeups/turnme/turnme3.png)
Ce type de modulation est très utilisé pour envoyer des données numériques comme avec des clés de portail. 
Bref, depuis **URH**, on peut sélectionner comme type de modulation **ASK**. On peut aussi changer le **Show sata as** en sélectionnant **ASCII** en bas à gauche afin de pouvoir lire les données en clair.
...
![image](../../assets/img/writeups/turnme/turnme4.png)
...
![image](../../assets/img/writeups/turnme/turnme5.png)
...
![image](../../assets/img/writeups/turnme/turnme6.png)
...
Ce paramètre sert à déterminer les pauses ou les intervalles de silence entre les données du signal. C'est en gros le nombre minimum d'échantillons de silence consécutifs qui faut pour dire *"Ah ! là y a une pause"* dans la transmission. 
...
![image](../../assets/img/writeups/turnme/turnme7.png)
