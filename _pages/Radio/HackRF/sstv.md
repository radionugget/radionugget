...
Si non, qu'importe le mode, ce sera toujours une résolution en **320x256 pixels**. Le **HackRF** ne prendra en charge que des images au format `.bmp` avec une taille de 320x256 donc. 
